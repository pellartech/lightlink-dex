...
const ModalUpper = styled(DataCard)`
  ...
  background: radial-gradient(76.02% 75.41% at 1.84% 0%, #44CCCA 0%, #021d43 100%);
`
...
const ConfirmOrLoadingWrapper = styled.div<{ activeBG: boolean }>`
  ...
  background: ${({ activeBG }) =>
    activeBG &&
    'radial-gradient(76.02% 75.41% at 1.84% 0%, rgba(68, 204, 202, 0.2) 0%, rgba(33, 114, 229, 0.2) 100%), #FFFFFF;'};
`
        ...
        <ConfirmOrLoadingWrapper activeBG={true}>
          ...
          <AutoColumn gap="100px" justify="center">
            <AutoColumn gap="md" justify="center">
              ...
              {!claimConfirmed && (
                <Text fontSize={36} color="#44CCCA" fontWeight={535}>
                  <Trans>{unclaimedAmount?.toFixed(0, { groupSeparator: ',' } ?? '-')} UNI</Trans>
                </Text>
              )}
              {parsedAddress && (
