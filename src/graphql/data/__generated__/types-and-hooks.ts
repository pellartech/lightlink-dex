...
export type BridgedWithdrawalInfo = {
  readonly __typename?: 'BridgedWithdrawalInfo';
...
export type V4Pool = {
  ...
  readonly id: Scalars['ID'];
  readonly isDynamicFee?: Maybe<Scalars['Boolean']>;
  readonly poolId: Scalars['String'];
  readonly priceHistory?: Maybe<ReadonlyArray<Maybe<TimestampedPoolPrice>>>;
  readonly protocolVersion: ProtocolVersion;
  readonly rewardsCampaign?: Maybe<RewardsCampaign>;
  readonly tickSpacing?: Maybe<Scalars['Int']>;
