...
import {
  ...
  MULTICALL_ADDRESSES as _MULTICALL_ADDRESSES,
  NONFUNGIBLE_POSITION_MANAGER_ADDRESSES as _NONFUNGIBLE_POSITION_MANAGER_ADDRESSES,
  TICK_LENS_ADDRESSES as _TICK_LENS_ADDRESSES,
  V2_ROUTER_ADDRESS,
  V3_MIGRATOR_ADDRESSES,
} from '@uniswap/sdk-core'
import { LIGHTLINK_CHAIN_ID, LIGHTLINK_ADDRESSES } from 'constants/chains'

// Extend SDK address maps with LightLink
const MULTICALL_ADDRESSES = { ..._MULTICALL_ADDRESSES, [LIGHTLINK_CHAIN_ID]: LIGHTLINK_ADDRESSES.MULTICALL2 }
const NONFUNGIBLE_POSITION_MANAGER_ADDRESSES = { ..._NONFUNGIBLE_POSITION_MANAGER_ADDRESSES, [LIGHTLINK_CHAIN_ID]: LIGHTLINK_ADDRESSES.NONFUNGIBLE_POSITION_MANAGER }
const TICK_LENS_ADDRESSES = { ..._TICK_LENS_ADDRESSES, [LIGHTLINK_CHAIN_ID]: LIGHTLINK_ADDRESSES.TICK_LENS }
